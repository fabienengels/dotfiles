...
require("nvim-treesitter.configs").setup({
  ensure_installed = { "arduino", "scss", "help", "json", "gitignore", "dockerfile", "lua", "python", "eex", "elixir", "heex", "fish", "html", "rust", "svelte", "typescript" },
...
local servers = { "svelte", "arduino_language_server", "jsonls", "pyright", "yamlls", "sumneko_lua", "rust_analyzer", "ansiblels", "bashls", "dockerls", "elixirls", "tsserver", "tailwindcss" }
